...
# 输入数据文件夹
input_pedestrian_folder = r"D:\songjiahao\DATA\reid\person"
input_vehicle_folder = r"D:\songjiahao\DATA\reid\car"

# 输出数据文件夹
output_root = r"D:\songjiahao\DATA\reid/Market1501"
...
def rename_and_split_images(input_folder, pid_start, camid, query_bool=False):
    pid = pid_start
...
# 处理行人数据
last_pid = rename_and_split_images(input_pedestrian_folder, 0, 1,query_bool=True)

# 处理车辆数据
rename_and_split_images(input_vehicle_folder, last_pid, 2, query_bool=True)
