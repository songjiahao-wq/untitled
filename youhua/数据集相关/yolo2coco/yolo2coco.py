...
if __name__ == '__main__':
    ...
    parser.add_argument('-ap', '--anno-path', type=str, default='./data/labels/train', help='yolo txt path')
    parser.add_argument('-s', '--save-path', type=str, default='./data/convert/coco/', help='json save path')
    parser.add_argument('--image-path', default='./data/images/train')
...
"""
python yolo2coco.py -ap D:/xian_yu/datasets/扶梯数据集v7/futi_yolo/labels/train
"""