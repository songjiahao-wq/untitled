...
if __name__ == "__main__":
    jsonfilePath = r"D:\xian_yu\data(1)\CRACK500\json\val/"  # 要转换的json文件所在目录
    resultDirPath = r"D:\xian_yu\data(1)\CRACK500\labels\val/"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["crack"])
